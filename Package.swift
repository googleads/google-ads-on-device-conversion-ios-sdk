...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleAdsOnDeviceConversion",
      url: "https://dl.google.com/firebase/ios/appads/3.1.0/GoogleAdsOnDeviceConversion.zip",
      checksum: "f37d4e6cabac6d11f00210eb645cb0042309f8c1ac5c2a36dd37a3c2768e5996"
    ),
  ],
