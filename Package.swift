...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleAdsOnDeviceConversion",
      url: "https://dl.google.com/firebase/ios/appads/3.4.1/GoogleAdsOnDeviceConversion.zip",
      checksum: "8d491bf3fb3b48c898da2185c2f4a6936c9ebd97d2fa94520f3fa646a9c8badb"
    ),
  ],
