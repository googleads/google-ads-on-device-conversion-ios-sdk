...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleAdsOnDeviceConversion",
      url: "https://dl.google.com/firebase/ios/appads/3.2.0/GoogleAdsOnDeviceConversion.zip",
      checksum: "4d4641e481589242b2ee76e0ad756dbe4059b46d781969441b47d5c2c2aca111"
    ),
  ],
